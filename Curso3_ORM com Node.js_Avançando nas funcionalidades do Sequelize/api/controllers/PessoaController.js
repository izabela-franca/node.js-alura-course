...
class PessoaController {
  ...
  static async pegaMatriculas(req, res) {   //Requisito 4: listar todas as matriculas de um aluno
  ...
  static async cancelaPessoa(req, res) {  //Requisito 8: cadastros desativados devem, automaticamente, mudar status de matricula para desativada
    const { estudanteId } = req.params
    try {
